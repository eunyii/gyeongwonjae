...
export const SlideImg1 = styled.div`
    width:630px; 
    height: 497px;
    background: url('gyeongwonjae/assets/dining/dining1.jpg') no-repeat center / cover;
`;
export const SlideImg2 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/dining/dining2.jpg') no-repeat center / cover;
    margin: 0 10px; 
`;
export const SlideImg3 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/dining/dining3.jpg') no-repeat center / cover;
`;
export const SlideImg4 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/wedding/wedding1.jpg') no-repeat center / cover;
`;
export const SlideImg5 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/wedding/wedding2.jpg') no-repeat center / cover;
    margin: 0 10px; 
`;
export const SlideImg6 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/wedding/wedding3.jpg') no-repeat center / cover;
`;
export const SlideImg7 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/party/party1.jpg') no-repeat center / cover;
`;
export const SlideImg8 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/party/party2.jpg') no-repeat center / cover;
    margin: 0 10px; 
`;
export const SlideImg9 = styled.div`
    width:630px;
    height: 497px;
    background: url('gyeongwonjae/assets/party/party3.jpg') no-repeat center / cover;
`;
